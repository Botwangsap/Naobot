...
let name = await conn.getName(who)
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    ...
    [`${nomorown1}`, `${await conn.getName(nomorown1+'@s.whatsapp.net')}`, `💌 Developer Bot `, `yameteh😋🥰`, `BotWhatsApp@gmail.com`, `🇮🇩 Indonesia`, `📍 https://instagram.com/anggatzi123`, `👤 Owner Lisabotz-MD`],
